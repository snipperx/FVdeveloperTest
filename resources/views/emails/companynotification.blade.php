...
<head>
    ...
    <title>{{ $name }} - New Company Added</title>
                            ...
                            <table cellpadding="0" cellspacing="0" class="force-full-width">
                                {{--<tr>--}}
                                    {{--<td height="60" valign="top" class="header-cell">--}}
                                        {{--<img width="196" height="60" src="" alt="logo">--}}
                                    {{--</td>--}}
                                {{--</tr>--}}
                                <tr>
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#ffffff">
                                            <tr>
                                                <td valign="top" style="padding-bottom:20px; background-color:#ffffff;">
                                                    Hi {{ $name }},<br><br>
                                                    We Would like to inform you that,Company: {{$name}} has been Successfully Added
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <tr>
                                    <td valign="top" class="footer-cell">
                                        .<br>
                                        Please do not reply to this email. If you have received this email by mistake, please contact our support team on <a href="mailto:info@admin.com">info@admin.com</a>.<br>
                                        Powered by <a href="http://test.co.za/" target="_blank">Assessment</a>
                                    </td>
                                </tr>
                            </table>
                        </td>
